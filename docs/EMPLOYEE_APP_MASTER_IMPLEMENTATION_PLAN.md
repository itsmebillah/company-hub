...
| Profile                  | Full employee details and editable approved fields                                                                       | View/edit name, employee ID, role, phone, email, date of birth; current photo display and fallback avatar                                                                         | `GET/PATCH /api/mobile/v1/profile` derives authenticated employee and company; updates only phone/email/date_of_birth       | Employee/profile schema exists                                                                                     | **PARTIALLY MIGRATED / NOT RELEASED**            | Server validation and tenant ownership; Flutter edit flow added; photo upload remains blocked pending native picker/storage adapter | `d58735b` | P0 | Protected identity fields remain read-only |
